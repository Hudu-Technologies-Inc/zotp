...
RSpec.describe ZOTP::OTP::URI do
  it 'meets basic functionality' do
    otp = ZOTP::TOTP.new('JBSWY3DPEHPK3PXP')
  ...
  it 'includes issuer' do
    otp = ZOTP::TOTP.new('JBSWY3DPEHPK3PXP', issuer: 'Example')
    uri = described_class.new(otp, account_name: 'alice@google.com')
  ...
  it 'encodes the account name' do
    otp = ZOTP::TOTP.new('JBSWY3DPEHPK3PXP', issuer: 'Provider1')
  ...
  it 'encodes the issuer' do
    otp = ZOTP::TOTP.new('JBSWY3DPEHPK3PXP', issuer: 'Big Corporation')
  ...
  it 'includes non-default SHA256 algorithm' do
    otp = ZOTP::TOTP.new('JBSWY3DPEHPK3PXP', digest: 'sha256')
    uri = described_class.new(otp, account_name: 'alice@google.com')
  ...
  it 'includes non-default SHA512 algorithm' do
    otp = ZOTP::TOTP.new('JBSWY3DPEHPK3PXP', digest: 'sha512')
    uri = described_class.new(otp, account_name: 'alice@google.com')
  ...
  it 'includes non-default 8 digits' do
    otp = ZOTP::TOTP.new('JBSWY3DPEHPK3PXP', digits: 8)
    uri = described_class.new(otp, account_name: 'alice@google.com')
  ...
  it 'includes non-default period for TOTP' do
    otp = ZOTP::TOTP.new('JBSWY3DPEHPK3PXP', interval: 35)
    uri = described_class.new(otp, account_name: 'alice@google.com')
  ...
  it 'includes non-default counter for HOTP' do
    otp = ZOTP::HOTP.new('JBSWY3DPEHPK3PXP')
